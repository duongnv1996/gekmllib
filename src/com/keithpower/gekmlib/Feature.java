...
abstract public class Feature extends ObjectNode
{
    ...
    protected List<StyleSelector> styleSelector = new ArrayList<StyleSelector>();
    ...
    {
        List<StyleMap> list = new ArrayList<StyleMap>();
        for (StyleSelector cur : getStyleSelectors())
        {
    ...
    public String toKML(boolean suppressEnclosingTags)
    {
      ...
      if(this.styleUrl!=null)
      {
        ...
        for (Iterator<StyleSelector> iter = this.styleSelector.iterator(); iter.hasNext();)
        {
            StyleSelector cur = iter.next();
            kml+=cur.toKML();
        }
        if(this.region!=null)
        {
    ...
    public Object clone() throws CloneNotSupportedException
    {
      ...
      {
        result.styleSelector = new ArrayList<StyleSelector>();
        for (Iterator<StyleSelector> iter = this.styleSelector.iterator(); iter.hasNext();)
        {
            StyleSelector element = iter.next();
