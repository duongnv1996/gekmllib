...
public class Update extends Node
{
    ...
    protected List<Change> change = new ArrayList<Change>();
    ...
    public String toKML(boolean suppressEnclosingTags)
    {
      ...
      if(this.targetHref!=null)
      {
        ...
        for (Iterator<Change> iter = this.change.iterator(); iter.hasNext();)
        {
            Change cur = iter.next();
            kml+=cur.toKML();
        }
        if(this.replace!=null)
        {
    ...
    public Object clone() throws CloneNotSupportedException
    {
      ...
      {
        result.change = new ArrayList<Change>();
        for (Iterator<Change> iter = this.change.iterator(); iter.hasNext();)
        {
            Change element = iter.next();
