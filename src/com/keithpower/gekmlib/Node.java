...
abstract public class Node implements Cloneable
{
    ...
    protected List<Node> removeDescendants(List<Node> list)
    {
    ...
    protected boolean containsAncestor(List<Node> list, Node newNode)
    {
	Node cur = newNode;
	...
	{
	    for (Iterator<Node> iter = this.deletedNodes.iterator(); iter.hasNext();)
	    {
	...
	{
	    for (Iterator<Node> iter = this.createdNodes.iterator(); iter.hasNext();)
	    {
		Node newNode = iter.next();
